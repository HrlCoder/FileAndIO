...
public class RequestResponseTask implements Runnable {
    ...
    private static final String SESSION_BASE = "D:\\课程\\2021-3-4-Java31-40班-HTTP项目\\预研阶段学习\\sessions";

    private static final String TEMPLATE_BASE = "D:\\课程\\2021-3-4-Java31-40班-HTTP项目\\预研阶段学习\\template";
    @Override
    public void run() {
        try {
            ...
            if (requestURI.equals("/get-book")) {
                ...
                try (InputStream is = new FileInputStream(TEMPLATE_BASE + "/hongloumeng.html")) {
